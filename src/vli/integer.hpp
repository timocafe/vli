...
namespace vli {
    ...
    public:
        ...
        static const std::size_t numwords = (NumBits+std::numeric_limits<value_type>::digits-1)/std::numeric_limits<value_type>::digits; // (63/64)
       // static const std::size_t numwords = (NumBits+63)/64; // (63/64)

...
class Timer {
public:
  Timer(std::string name_) : val(0), name(name_), freq(2.66e9), nCounter(0) {}
...
public:
  ...
  void end() {
    ...
    val = static_cast<double>(elapsedTime) /
          1000; // because time is in milisecond
  }
